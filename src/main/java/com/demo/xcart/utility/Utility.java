package com.demo.xcart.utility;
...
public class Utility extends BasePage {
    ...
    //Method to assert expected and actual text
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/uk/co/barclays/screenshot/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/uk/co/barclays/screenshot/" + screenshotName + dateName + ".png";
